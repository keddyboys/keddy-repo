...
import localdb
base_url = 'http://filme-seriale.online'
...
def ROOT():
    ...
    addDir('Lista Seriale', 'http://filme-seriale.online/seriale-online', 6, movies_thumb, 'recente', 'seriale')
    addDir('Episoade adaugate Recent', 'http://filme-seriale.online/episod', 6, movies_thumb, 'recente', 'episoade')
